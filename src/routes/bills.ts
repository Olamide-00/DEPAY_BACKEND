...
import {
  ...
  getServiceVariationsController,
  payBillController,
} from "../controller/version2/bills/serviceController.js";
import {
  getFeeQuoteController,
  listChargesController,
} from "../controller/version2/bills/feeController.js";
import { transactionLimiter } from "../utils/version2/rateLimiter.js";

const router = express.Router();

router.get("/get-services", getServicesController);
router.get("/charges", listChargesController);
router.get("/fee-quote", getFeeQuoteController);
