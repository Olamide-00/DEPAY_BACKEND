...
// GET /api/admin/chart
// ══════════════════════════════════════════════════════
export const getDashboardChart = async (req: Request, res: Response): Promise<Response | void> => {
  try {
    const { period = "7days" } = req.query;
    const { from, to } = getDateRange(String(period));
...
// ══════════════════════════════════════════════════════
export const getSalesBreakdown = async (req: Request, res: Response): Promise<Response | void> => {
  try {
    const { period = "7days" } = req.query;
    const { from, to } = getDateRange(String(period));
...
// ══════════════════════════════════════════════════════
export const getRecentTransactions = async (req: Request, res: Response): Promise<Response | void> => {
  try {
...
// ══════════════════════════════════════════════════════
export const getEarnings = async (req: Request, res: Response): Promise<Response | void> => {
  try {
    const { period = "7days" } = req.query;
    const { from, to } = getDateRange(String(period));
